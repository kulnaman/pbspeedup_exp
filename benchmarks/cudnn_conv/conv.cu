...
int main(int argc, const char* argv[]) {
  ...
  cudnnConvolutionFwdAlgoPerf_t best_convolution_alo_data[5]; 
  ...
  checkCUDNN(
      cudnnGetConvolutionForwardAlgorithm_v7(cudnn,
                                          ...
                                          5,
                                          &return_algo_count,
                                          best_convolution_alo_data));
  convolution_algorithm = best_convolution_alo_data[0].algo;
  std::cout<<convolution_algorithm<<std::endl;
  
  std::cout<<"memory requirement"<<best_convolution_alo_data[0].memory<<std::endl;
  ...
  checkCUDNN(cudnnGetConvolutionForwardWorkspaceSize(cudnn,
                                                     ...
                                                     &workspace_bytes));
  std::cout<<"Amount of memory"<<workspace_bytes<<std::endl;
