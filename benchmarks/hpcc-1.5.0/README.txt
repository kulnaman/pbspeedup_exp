...
*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=
Customized change to support single benchmark run. Changed in July 2020.
1. added function parse_arguments to parse arguments which are program names.
2. changed main to encapsulate each program within an if statement. Run a program if it is enabled.  
