...
def main():
    ...
    parser = argparse.ArgumentParser(description="CUFFT experiments over power ranges and spatial for gpu and cpu")
    ...
    try:
        ...
        gpu_exp = Experiment("cufft",f"common", "gpu", "./simpleCUFFT", [])
